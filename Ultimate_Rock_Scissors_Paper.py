...
file = np.genfromtxt('data/gesture_all.csv', delimiter=',')
        ...
        for res in result.multi_hand_landmarks:
            ...
            if len(rps_result) >= 2:
                ...
                if rps_result[0]['rps']=='rock':
                    ...
                    elif rps_result[1]['rps']=='fuckyou': text = 'FuckYou wins' ; winner = 1
                ...
                elif rps_result[0]['rps']=='fuckyou':
                    if rps_result[1]['rps']=='rock'     : text = 'FuckYou wins'; winner = 0
                    elif rps_result[1]['rps']=='paper'  : text = 'FuckYou wins'; winner = 0
                    elif rps_result[1]['rps']=='scissors': text = 'FuckYou wins'; winner = 0
                    elif rps_result[1]['rps']=='fuckyou': text = 'Tie'
